...
const admin_uri ="mongodb+srv://jitinchekka2:tsdG1S4YqB2tbQEq@cluster0.cdnvlxs.mongodb.net/?retryWrites=true&w=majority";
...
// Read Endpoint: GET /admin
// Update Endpoint: PUT /admin
app.post("/admin", (req, res) => {
	console.log(">",req.body);
  const { Admin_email,Industries, type_of_post, target_audience, number_of_free_prompts } =
    req.body;
  const adminData = {
    Admin_email,
    Industries,
